...
ols.mod <- readRDS(paste0(model.dump.string, "ols_model.RDS"))

freq.ridge.mod <- readRDS(paste0(model.dump.string, "freq_ridge_model.RDS"))

freq.lasso.mod <- readRDS(paste0(model.dump.string, "freq_lasso_model.RDS"))

blm.sims <- readRDS(paste0(model.dump.string, "blm_sims.RDS"))

ridge.sims <- readRDS(paste0(model.dump.string, "ridge_sims.RDS"))

lasso.sims <- readRDS(paste0(model.dump.string, "lasso_sims.RDS"))
