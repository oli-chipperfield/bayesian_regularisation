...
for (i in 1:NROW(lambda.array)) {
  ...
  saveRDS(ridge.lambda.sims, paste0(model.dump.string, "ridge_lambda_sims_",i,".RDS"))
  ...
  for (j in 1:l.k.number) {
    ...
    saveRDS(ridge.lambda.k.sims, paste0(model.dump.string, "ridge_lambda_k_sims_",i,".RDS"))
...
for (i in 1:NROW(lambda.array)) {
  ...
  saveRDS(lasso.lambda.sims, paste0(model.dump.string, "lasso_lambda_sims_",i,".RDS"))
  ...
  saveRDS(lasso.lambda.k.sims, paste0(model.dump.string, "lasso_lambda_k_sims_",i,".RDS"))
