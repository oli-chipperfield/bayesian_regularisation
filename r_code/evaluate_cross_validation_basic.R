...
source("evaluate_model_parameters_basic.R")
...
ols.k.sims <- readRDS(paste0(model.dump.string, "ols_k_sims_basic.RDS"))

freq.ridge.k.sims <- readRDS(paste0(model.dump.string, "freq_ridge_k_sims_basic.RDS"))

freq.lasso.k.sims <- readRDS(paste0(model.dump.string, "freq_lasso_k_sims_basic.RDS"))

blm.k.sims <- readRDS(paste0(model.dump.string, "blm_k_sims_basic.RDS"))

ridge.k.sims <- readRDS(paste0(model.dump.string, "ridge_k_sims_basic.RDS"))

lasso.k.sims <- readRDS(paste0(model.dump.string, "lasso_k_sims_basic.RDS"))
