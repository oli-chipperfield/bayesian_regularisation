...
saveRDS(ols.k.sims, paste0(model.dump.string, "ols_k_sims.RDS"))
...
saveRDS(freq.ridge.k.sims, paste0(model.dump.string, "freq_ridge_k_sims.RDS"))
...
saveRDS(freq.lasso.k.sims, paste0(model.dump.string, "freq_lasso_k_sims.RDS"))
...
saveRDS(blm.k.sims, paste0(model.dump.string, "blm_k_sims.RDS"))
...
saveRDS(ridge.k.sims, paste0(model.dump.string, "ridge_k_sims.RDS"))
...
saveRDS(lasso.k.sims, paste0(model.dump.string, "lasso_k_sims.RDS"))
